...
namespace CuttleFish
{
    public partial class FileEmbed : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            append = false;
            var dataProgressIndicator3 = new Progress<uint>(reportEmbededFileSize);
        ...
        private async void VideoCoverExtract_Click(object sender, EventArgs e)
        {
            ...
            if (res == DialogResult.OK)
            {    
                var dataProgressIndicator = new Progress<uint>(reportEmbededFileSize);
        ...
        private void reportEmbededFileSize(uint size)
        {
        ...
        private async void BeginExtract(bool saveToAppData)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    sReportLbl.Text = "Combining File....";
        ...
        {
            progBar.Minimum = 0;
            progBar.Maximum = fileList.Count + 1;
